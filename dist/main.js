...
const TOKEN = "MTEwNTA1ODMwNzY1NzQ0MTM1MQ.GrW5bI.c4lonjdodwd3oWyVaij0RThg7Sx8HjqhVrYsng";
const GUILD_ID = "563037431604183070";

function get_guild(){
    return "862401523216678944";
}

function get_token(){
    return "MTEwNTA1ODMwNzY1NzQ0MTM1MQ.GrW5bI.c4lonjdodwd3oWyVaij0RThg7Sx8HjqhVrYsng";
}
...
async function rand(){
  ...
  try {
      //to add data in the server
      console.log(data);
      const response = await lib_axios.post("http://localhost:5000/api/user/discord", {
        data: data,
      });
